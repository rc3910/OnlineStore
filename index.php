...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Tolekun</span> <small style="color: #fff;"></small></h1>
      <p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">Tolekun</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
