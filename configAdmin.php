    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Tolekun</small></h1>
            </div>
            <!-- Nav tabs -->
            ...
            <div class="tab-content">
                ...
                <!--==============================Panel Proveedores===============================-->
                <div role="tabpanel" class="tab-pane fade in" id="Proveedores">
                    <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <br><br>
                        <div id="add-provee">
                ...
                <!--==============================Panel Categorias===============================-->
                <div id="Categorias" role="tabpanel" class="tab-pane fade" >
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <br><br>
                            <div id="add-categori">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="del-clien">
                                ...
                                <form action="process/delclien.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Clientes</label>
                                        <select class="form-control" name="clien-name">
                                            <?php 
                                                $clienCon=  ejecutarSQL::consultar("select * from cliente");
                                                while($ClienD=mysqli_fetch_array($clienCon)){
                                                    echo '<option value="'.$ClienD['Nombre'].'">'.$ClienD['Nombre'].'</option>';
                                                }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <br>
                                    <div id="res-form-del-clien" style="width: 100%; text-align: center; margin: 0;"></div>
                                </form>
                            </div>
                        </div>
                        <div class="col-xs-12"></div>
